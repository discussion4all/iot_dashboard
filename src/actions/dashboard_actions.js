...
import { GET_ERRORS, GET_DASHBOARD_LAYOUT, SAVE_DASHBOARD_LAYOUT } from "./types";
...
export const saveDashboard = dashboardData => dispatch => {
	...
	console.log('Dashboard body Data>>>',dashboardData);
	axios.post(`${config.DYNAMODB_API_DOMAIN}/user/saveDashboard`,dashboardData)
	.then((response) => {
