                ...
                <GridContainer>
                  <GridItem xs={12} sm={12} md={6} className={classes.myclass}>
                    ...
                    <div className="cardClass">
                      <div>
                        <Button className={classes.myCustomButton}>LogOut</Button>
              ...
              <CardBody className={sidebarWrapper}>
                <GridContainer>
                  <GridItem xs={12} sm={12} md={6} className={classes.myclass}>
                    ...
                    <div className="cardClass">
                      <div>
                        <Button className={classes.myCustomButton} onClick={this.logout}>LogOut</Button>
                        <Button className={classes.myCustomButton}>Client</Button>
                        <Button color="info" className={classes.myCustomButton} routename="charts" onClick={this.goto}>
                          Charts
                        </Button>
                        <Button color="primary" className={classes.myCustomButton}>
                          Application
